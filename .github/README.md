...
[`@aws-sdk/client-kinesis-video-webrtc-storage`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video-webrtc-storage/v/3.1095.0).
...
- @aws-sdk/client-kinesis-video-webrtc-storage v3.1095.0 - [https://cloud-sdk-builds.github.io/?sdk=client-kinesis-video-webrtc-storage&version=3.1095.0](https://cloud-sdk-builds.github.io/?sdk=client-kinesis-video-webrtc-storage&version=3.1095.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video-webrtc-storage@3.1095.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DBtCmEATTTkXNfb35bnpU+m2Qdh0A3W2NU1qox0rCl2CSnkPw9mEFA+18NgIQvMQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video-webrtc-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video-webrtc-storage@3.1095.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video-webrtc-storage@3.1095.0/index.min.mjs": "sha384-DBtCmEATTTkXNfb35bnpU+m2Qdh0A3W2NU1qox0rCl2CSnkPw9mEFA+18NgIQvMQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video-webrtc-storage/blob/refs/tags/3.1095.0/LICENSE
```
